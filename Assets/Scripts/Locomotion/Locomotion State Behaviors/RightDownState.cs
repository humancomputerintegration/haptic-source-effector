...
public class RightDownState : LocomotionStateBehavior
{
    ...
    /* Change states if nothing has happend for too long, if the user is somehow flying, or if the left foot is lifted */
    private protected override LocomotionState FindNextState() {
        ...
        else if (feet.LeftState == FootState.Up){
